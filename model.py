...
def build_model(args,train):
    ...
    if args.model_name == "yolo":
        ...
        Conv7X7 = layers.Conv2D(32,(7, 7),activation='relu',padding='same',name="tuamae")(input_shape)

        Conv1X1 = layers.Conv2D(32,(1, 1),activation='relu',padding='same')(Conv7X7)
        Conv3X3 = layers.Conv2D(32,(3, 3),activation='relu',padding='same')(Conv7X7)
        Conv5X5 = layers.Conv2D(32,(5, 5),activation='relu',padding='same')(Conv7X7)
        ...
        x  = layers.Conv2D(64, (3, 3), activation='relu')(x)
        x   = layers.MaxPooling2D(2, 2)(x)
        x  = layers.Conv2D(128, (3, 3), activation='relu',name="SemiFinalConv")(x)
        x   = layers.MaxPooling2D(2, 2,name="SemiFinalPooling")(x)
        x  = layers.Conv2D(128, (3, 3), activation='relu',name="FinalConv")(x)
